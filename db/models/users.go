...
var (
	userAllColumns            = []string{"user_id", "family_name", "given_name", "email_address", "registration_date"}
	userColumnsWithoutDefault = []string{"family_name", "given_name", "email_address", "registration_date"}
